/**
 * Shared tsdown preset for UI plugin client bundles — adapted from
 * dsh-balance-meter's `shared/tsdown.client.ts`, which itself is a copy of
 * the DSH checkout's `packages/client/tsdown.client.ts`. Emits a
