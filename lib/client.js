window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const css = ".sFRYMq_wrap{display:inline-flex;position:relative}.sFRYMq_chip{border:1px solid var(--dsh-color-border,#80808059);background:var(--dsh-color-surface,transparent);height:22px;color:var(--dsh-color-text,inherit);cursor:pointer;white-space:nowrap;user-select:none;border-radius:999px;align-items:center;gap:6px;padding:0 8px;font-size:12px;line-height:1;display:inline-flex}.sFRYMq_chip:hover,.sFRYMq_chipOpen{border-color:var(--dsh-color-accent,#50a0ffb3)}.sFRYMq_seg{align-items:baseline;gap:3px;display:inline-flex}.sFRYMq_segSep{opacity:.45}.sFRYMq_segWarn{color:var(--dsh-color-warning,#d29922)}.sFRYMq_segErr{color:var(--dsh-color-danger,#e5534b)}.sFRYMq_details{z-index:40;border:1px solid var(--dsh-color-border,#80808059);background:var(--dsh-color-surface-elevated,#1f1f1f);min-width:220px;color:var(--dsh-color-text,inherit);border-radius:8px;flex-direction:column;gap:6px;padding:8px 10px;font-size:12px;display:flex;position:absolute;bottom:calc(100% + 6px);left:50%;transform:translate(-50%);box-shadow:0 4px 12px #0000004d}.sFRYMq_window{justify-content:space-between;align-items:center;gap:12px;display:flex}.sFRYMq_windowLabel{color:var(--dsh-color-text-secondary,inherit);opacity:.9;align-items:center;gap:6px;display:inline-flex}.sFRYMq_windowValue{font-variant-numeric:tabular-nums;align-items:baseline;gap:6px;display:inline-flex}.sFRYMq_windowReset{opacity:.65;font-variant-numeric:tabular-nums;font-size:11px}.sFRYMq_foot{border-top:1px solid var(--dsh-color-border,#80808040);justify-content:space-between;align-items:center;gap:8px;padding-top:6px;font-size:11px;display:flex}.sFRYMq_footRight{align-items:center;gap:8px;margin-left:auto;display:inline-flex}.sFRYMq_setBtn{color:var(--dsh-color-accent,#50a0ffe6);cursor:pointer;background:0 0;border:0;padding:0;font-size:11px}.sFRYMq_setBtn:hover{text-decoration:underline}.sFRYMq_fetchedAt{opacity:.6}.sFRYMq_refreshBtn{color:var(--dsh-color-accent,#50a0ffe6);cursor:pointer;background:0 0;border:0;padding:0;font-size:11px}.sFRYMq_refreshBtn:hover{text-decoration:underline}.sFRYMq_setPanel{flex-direction:column;gap:8px;min-width:260px;display:flex}.sFRYMq_field{flex-direction:column;gap:3px;display:flex}.sFRYMq_fieldLabel{color:var(--dsh-color-text-secondary,inherit);opacity:.75;font-variant-numeric:tabular-nums;font-size:11px}.sFRYMq_fieldInput{box-sizing:border-box;border:1px solid var(--dsh-color-border,#80808059);background:var(--dsh-color-surface,transparent);width:100%;color:var(--dsh-color-text,inherit);font-variant-numeric:tabular-nums;border-radius:6px;outline:none;height:26px;padding:0 8px;font-size:12px}.sFRYMq_fieldInput:focus{border-color:var(--dsh-color-accent,#50a0ffb3)}.sFRYMq_setHint{opacity:.55;font-size:11px}.sFRYMq_errorText{color:var(--dsh-color-danger,#e5534b);white-space:normal;max-width:240px;font-size:11px}";
		...
		var ocgo_module_css_default = {
			...
			"seg": "sFRYMq_seg",
			"segErr": "sFRYMq_segErr",
			"segSep": "sFRYMq_segSep",
			"segWarn": "sFRYMq_segWarn",
