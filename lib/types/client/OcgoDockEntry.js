...
function OcgoLogo() {
    ...
    if (dark) {
        return (_jsxs("svg", { className: css.logo, width: "22", height: "12", viewBox: "0 0 54 30", fill: "none", xmlns: "http://www.w3.org/2000/svg", "aria-hidden": "true", children: [_jsx("rect", { width: "100%", height: "100%", fill: "#2c2c2e" }), _jsx("path", { d: "M24 30H0V0H24V6H6V24H18V18H12V12H24V30Z", fill: "#B0B0B0" }), _jsx("path", { d: "M12 18H18V24H6V12H12V18Z", fill: "#2c2c2e" }), _jsx("path", { d: "M48 12V24H36V12H48Z", fill: "#2c2c2e" }), _jsx("path", { d: "M54 30H30V0H54V30ZM36 24H48V6H36V24Z", fill: "#B0B0B0" })] }));
    }
...
function WindowSegment(props) {
    ...
    return (_jsxs("span", { className: css.seg, children: [_jsx("span", { className: css.segSep, children: sep }), _jsxs("span", { className: cls ?? undefined, children: [WINDOW_LABELS[window.kind], " ", window.percent, "%", !compact ? ` (${formatDuration(window.resetInSec)})` : ''] })] }));
}
